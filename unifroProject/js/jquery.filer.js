            ...
            var s = $(r),
                ...
                f = {
                    init: function() {
                        ...
                        p = s.closest(b);
                        f._changeInput();
                        n['captions']['errors']['filesType'] = s.attr('data-jfiler-caption');
                    },
                    ...
                    _thumbCreator: {
                        ...
                        renderFile: function(file, html, opts) {
                            ...
                            if (file.file && opts.type == "image") {
                                var g = '<img src="' + file.file + '" data-id="' + file.id + '" draggable="false" />',
                        ...
                        _box: function(params) {
                            ...
                            if (l.length < 1) {
                                ...
                                l.append(f._assets.textParse(n.templates.box)).prependTo(appendTo);
                                ...
                                l.on('click', n.templates._selectors.remove, function(e) {
                                    ...
                                    if (cf)
									{
										var pid = $(this).closest(n.templates._selectors.item).find('img').attr('data-id');

										if(pid)
										{
										    var delImage = f._remove(e, $(this).closest(n.templates._selectors.item));

											$(this).closest(n.templates._selectors.item).find('a').parent('li').append('<img src="/img/loader-tiny.gif">');
											$(this).closest(n.templates._selectors.item).find('a').hide();
											...
											$.ajax({
												...
												$(this).closest(n.templates._selectors.item).find('li').remove('<img src="/img/loader-tiny.gif">');
												$(this).closest(n.templates._selectors.item).find('a').show();
												...
												{
													AlertBox($('<div class="error text-danger"></div>').html(response.error));
												}
											}).fail(function(response) {
												AlertBox(response.status + ': ' + response.statusText);
											})
										}
										else
                                        {
                    ...
                    _upload: function(i) {
                        ...
                        formData.append('id', s.attr('data-jfiler-id'));
