<?php
    ...
    {
    	if(VerifyFormToken('ResetPasswordForm'))
    	{
    		...
    		else
    		{
    			...
    			MysqlQuery("UPDATE customers SET Password = '".$NewPass."', ForgotPasswordLink = '' WHERE ForgotPasswordLink = '".$PasswordHash."'");

    			if(MysqlAffectedRows() == 1)
    			{
                    RecordMemberActivity('Password Reset', 'sales', $MemberDetails['MemberID']);
            ...
            <div class="center-box" style="border: 1px solid #ccc">
                ...
                <div class="col-sm-12">
                    <form id="loginform" method="post" onsubmit="ShowProcessing('Resetting password...')">
                        <input type="hidden" name="token" value="<?=GenerateFormToken('ResetPasswordForm')?>">
