<?php
    ...
    $GetAdditionalDetails = MysqlQuery("SELECT AdditionalDetails FROM client_order_details WHERE OrderDetailsID = '".$_POST['id']."' LIMIT 1");
...
?>
    ...
    <form id="AdditionalDetailsForm">
        ...
        {
            ?>
                <input type="hidden" name="OrderDetailsID" value="<?=$_POST['id']?>" />
        ...
        elseif($_POST['option'] == 'Pinafores' || $_POST['option'] == 'Skirt')
        {
            ?>
                ...
                <div class="mg-t-30 pd-b-30">
                    <button type="button" class="btn btn-primary" onclick="AddProductAttribute(this, true)">Save Details</button>
                </div>
