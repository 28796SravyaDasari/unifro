<?php
    ...
    $ListOrders = "SELECT o.OrderID FROM customer_orders o LEFT JOIN customers c ON c.MemberID = o.MemberID LEFT JOIN customer_order_status os ON os.OrderID = o.OrderID";
                                ...
                                <div class="filter-box">
                                    <form>
                                        <ul class="filters list-inline">
                                            ...
                                            <li>
                                                <input type="text" class="form-control xs <?=$ActiveFilter['q']?>" name="q" placeholder="Order ID / Customer Name" value="<?=$_GET['q']?>">
                                            </li>
                                            <li>
                                        ...
                                        <table class="table" data-expand-first="false" data-toggle-column="last">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-breakpoints="md sm xs">Customer</th>
                                            ...
                                            <tbody>
                                                ...
                                                if($TotalRecords > 0)
                                            	{
                                            	    ...
                                            	    $ListOrders = "SELECT o.OrderID, o.FinalTotal, o.OrderDate, o.PaymentStatus, os.Status, c.FirstName, c.LastName FROM customer_orders o
                                                                ...
                                                                <td>
                                                                    <div class="action-list">
                                                                        ...
                                                                        <ul class="sub-menu">
                                                                            ...
                                                                            <li><a href="#" data-id="'.$row['OrderID'].'" onclick="DeleteCustomerOrder(this)">Delete Order</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </td>
                                                            </tr>';
