<?php
    ...
    if(is_numeric($_POST['OrderID']))
    {
        ...
        -----------------------------------------------------------*/
        $OrderDetails = MysqlQuery("SELECT * FROM customer_orders WHERE OrderID = '".$_POST['OrderID']."' LIMIT 1");
        $OrderDetails = mysqli_fetch_assoc($OrderDetails);

        $GetProducts = MysqlQuery("SELECT * FROM customer_order_details WHERE OrderID = '".$_POST['OrderID']."'");
    ...
    <div>
        ...
        <div class="order-summary">
            <table align="right" class="table">
                ...
                <tr>
                    <td>Shipping Cost</td>
                    <td style="text-align:right"><?=FormatAmount($ShippingCost)?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="net-amount" style="text-align:right"><?=FormatAmount(($GrandTotal + $ShippingCost) - $CouponDiscount)?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="padding-top: 0">Authorised Signatory</td>
                </tr>
            </table>
        </div>
    </div>
